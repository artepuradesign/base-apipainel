              ...
              <div className="space-y-2">
                {telefonesData.map((telefone, index) => (
                  <div key={index} className="p-3 border rounded-md">
                    <p className="font-medium">{telefone.telefone}</p>
                    <p className="text-sm text-muted-foreground">{telefone.tipo}</p>
                    {telefone.observacao && <p className="text-sm">{telefone.observacao}</p>}
                  </div>
                ))}
              </div>
            ) : (
