    ...
    return (
      <Card>
        <CardHeader>
          ...
          <CardDescription>Credenciais de email vazadas</CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <CardContent>
        {senhas.length === 0 ? (
          <div className="text-center py-4 text-muted-foreground">
            ...
            <p className="text-sm">Nenhuma senha de email vazada encontrada</p>
          </div>
        ) : (
            ...
            {senhas.map((senha, index) => (
              <div key={senha.id}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <Label htmlFor={`email_${senha.id}`}>Email</Label>
                    <Input
                      id={`email_${senha.id}`}
                      value={senha.email || '-'}
                      disabled
