  ...
  return (
    ...
    >
      ...
      <button
        ...
        className={`w-[50px] h-[50px] bg-black hover:bg-gray-900 text-white rounded-full shadow-lg hover:shadow-xl flex items-center justify-center group transition-all duration-500 ease-out ${
      ...
      <button
        ...
        className={`w-[50px] h-[50px] bg-gradient-to-br from-purple-600 via-pink-500 to-orange-400 hover:from-purple-700 hover:via-pink-600 hover:to-orange-500 text-white rounded-full shadow-lg hover:shadow-xl flex items-center justify-center group transition-all duration-500 ease-out ${
      ...
      <button
        ...
        className={`w-[50px] h-[50px] bg-[#0088cc] hover:bg-[#007ab8] rounded-full shadow-lg hover:shadow-xl flex items-center justify-center group transition-all duration-500 ease-out ${
      ...
      >
        ...
        <span className="absolute right-full mr-3 top-1/2 -translate-y-1/2 bg-[#0088cc] text-white px-3 py-1 rounded-lg text-sm font-medium whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none">
